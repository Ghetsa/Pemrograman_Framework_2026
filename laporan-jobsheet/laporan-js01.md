...
```
![alt text](../jobsheet-01/my-app/public/image.png)
...
![alt text](../jobsheet-01/my-app/public/image-1.png)
2.  Jalankan perintah:
``` bash
npx create-next-app@13.4.7
```
![alt text](../jobsheet-01/my-app/public/image-2.png)
3.  Masuk ke folder project:

``` bash
cd my-app
```
![alt text](../jobsheet-01/my-app/public/image-3.png)
...
npm run dev
```
![alt text](../jobsheet-01/my-app/public/image-4.png)
Buka browser dan akses:

    http://localhost:3000
![alt text](../jobsheet-01/my-app/public/image-5.png)
------------------------------------------------------------------------
...
-   `pages/` → Tempat routing halaman ![alt text](../jobsheet-01/my-app/public/image-6.png)
-   `public/` → Aset statis ![alt text](../jobsheet-01/my-app/public/image-7.png)
-   `styles/` → File CSS ![alt text](../jobsheet-01/my-app/public/image-8.png)
-   `package.json` → Konfigurasi project ![alt text](../jobsheet-01/my-app/public/image-9.png)
-   `.gitignore` → File yang tidak di-track Git ![alt text](../jobsheet-01/my-app/public/image-10.png)
...
Buka file:
    ...
    pages/index.js
![alt text](../jobsheet-01/my-app/public/image-11.png)
Ubah isi halaman sesuai kebutuhan, lalu simpan dan lihat perubahan di
browser.
![alt text](../jobsheet-01/my-app/public/image-12.png)
------------------------------------------------------------------------
...
```
    pages/api
```
![alt text](../jobsheet-01/my-app/public/image-13.png)
2.  Modifikasi file `hello.ts` 
![alt text](../jobsheet-01/my-app/public/image-14.png)
3.  Akses melalui browser:
![alt text](../jobsheet-01/my-app/public/image-15.png)
...
rapi.
![alt text](../jobsheet-01/my-app/public/image-16.png)
------------------------------------------------------------------------
...
```
    _app.tsx
```
![alt text](../jobsheet-01/my-app/public/image-17.png)
2.  Modifikasi sesuai kebutuhan.
![alt text](../jobsheet-01/my-app/public/image-18.png)
3.  Jalankan kembali localhost dan lihat perubahan.
![alt text](../jobsheet-01/my-app/public/image-19.png)
------------------------------------------------------------------------
...
![alt text](../jobsheet-01/my-app/public/image-20.png)
------------------------------------------------------------------------
...
![alt text](../jobsheet-01/my-app/public/image-21.png)
------------------------------------------------------------------------
...
![alt text](../jobsheet-01/my-app/public/image-22.png)
------------------------------------------------------------------------
